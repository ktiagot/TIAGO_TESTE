        ...
        <div class="col-xl-3 col-sm-6 mb-3">
          <div class="card text-white bg-warning o-hidden h-100">
            <div class="card-body">
              ...
              <div class="mr-5">Motoristas</div>
            </div>
            <a class="card-footer text-white clearfix small z-1" href="php/cadastrar_motoristas.php">
              <span class="float-left">Clique aqui para cadastrar</span>
        ...
        <div class="col-xl-3 col-sm-6 mb-3">
          <div class="card text-white bg-warning o-hidden h-100">
            <div class="card-body">
              ...
              <div class="mr-5">Passageiros</div>
            </div>
            <a class="card-footer text-white clearfix small z-1" href="php/cadastrar_passageiros.php">
              <span class="float-left">Clique aqui para cadastrar</span>
              <span class="float-right">
                <i class="fa fa-angle-right"></i>
              </span>
        ...
        <div class="col-xl-3 col-sm-6 mb-3">
          <div class="card text-white bg-danger o-hidden h-100">
            <div class="card-body">
              ...
              <div class="mr-5">Corridas</div>
            </div>
            <a class="card-footer text-white clearfix small z-1" href="php/cadastrar_corridas.php">
              <span class="float-left">Clique aqui para cadastrar</span>
              <span class="float-right">
                <i class="fa fa-angle-right"></i>
              </span>
